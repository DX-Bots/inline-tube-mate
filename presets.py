class Presets(object):
    HELP_TEXT = """
<b><u>How to Use The Bot with Inline:</u></b>
<code>
...
<b>Join:</b><a href='https://t.me/TeleRoidGroup'><b>@TheTeleRoidGroup</b></a> | Repo\
<a href='https://github.com/PredatorHackerzZ'><b> LINK</b></a>   
    """
    ...
    DEFAULT_TITLE = "Aryan-Vikash YouTube Repository"
    DEFAULT_THUMB_URL = "https://telegra.ph/file/85d8f57042337d8dc44e4.jpg"
    DEFAULT_LINK = "https://t.me/MoviesFlixers_DL"
    DEFAULT_DESCRIPTION = "Link: PredatorHackerzZ | GitHub"
    DEV_TITLE = "Developer Of The Bot"
    DEV_THUMB_URL = "https://telegra.ph/file/f47ff655aad52231df3a5.jpg"
    DEV_LINK = "https://t.me/TheTeleRoid"
    DEV_DESCRIPTION = "Name: PredatorHackerzZ | Instagram"
    SHARE_BUTTON_TEXT = "Heya.. 👋\nCheckout : @{username}\nFor search and download TouTube Videos"
    SAVED_THUMB = "<b>✅ Thumbnail Saved Successfully</b>\n<code>This file will be used in next YouTube Link." \
    ...
    THUMB_CAPTION = "<code>This image is your current thumbnail, Tap </code><b> DEL THUMB </b><code> if you wish to " \
                    "clear it !</code> "
    NO_THUMB = " Can't find any saved thumbnail, Please upload an image to set it.."
    ...
    DOWNLOAD_START = "📥 <code>Downloading Your Given YouTube Link...</code>"
    UPLOAD_START = "📤 <code>Uploading Your Given YouTube Link...</code>"
    NOT_DOWNLOADABLE = "<b>This URL is not downloadable In This Bot!</b> 🙄"
    ...
    SEND_TEXT = "<b>Processing...</b>\n<i>This message will automatically disappear when the broadcasting is " \
                "finished</i> "
    REPLY_ERROR = "<i>Use this command as a replay to any telegram message without any spaces.</i>"
...
👇<code>Select the required format</code>👇
    """
    NOT_SUB_TXT = "<b>Oopz </b> 😯\n\n<code>You need to join my channel to use This Bot.</code>"
    BOT_NOT_PRESENT = "<b>Error : </b>\n\n<code>Something Went Wrong. Report at Support Group @TeleRoid14!</code>"
...
URL | newfilename | username | password"""
    CUSTOM_CAPTION_UL_FILE = "\xad \xad\n<b>{}</b>\n\n<b>DL Credits: </b><b><a " \
                             "href='https://github.com/PredatorHackerzZ'>Predator</a></b> "
